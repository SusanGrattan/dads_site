<?php
 ...
 ?>
<h1 class="text-right">Tips</h1>
<div class="row">
  <div class="columns small-12 medium-9 tips">
    ...
    <ul class="no-bullet">
      ...
      <li><h5 class="subheader">Wading</h5>
      ...
      <li>
        Waders can fill up with water.  If the water is murky, <em>Don't venture deep unless you know the area.</em>  Prop washouts are frequent here and you can step in a hole and be in trouble.  Also be aware of drop-offs.
      </li>
      <li>
      ...
      <li><h5 class="subheader">Snorkeling</h5>
      ...
      <li>
        The easiest is in sand, you wave your hand over the sand and it makes a small crater and your target appears.  My favorite to see a gold ring appear. Do not dig with your bare hands!  Glass, rusted cans and shotgun shell bottoms are sharp and it's too easy to get cut.
      </li>
      <li>
        Next easiest is muck.  <em>Carfully</em> take handfuls of it in your hand and put them in front of your coil.  Once you have the target in your hand, put the whole handful in a small mesh bag you carry and hold the top closed.  Swish it in the water reach in and carfully take out your target.   In this case you need to carry two bags or have pockets in your BC you can put your targets in.
      </li>
      <li>
      ...
      <li>
        Ok, you found your target and want to look at.  <em>Don't!</em>  As a diver, snorkeler or wader, you’re wasting air or hunting time.  You have plenty of time after to admire, look for karat marks or see what date it is after its time to quit or after you get home.  When I hunt, I hunt and just keep my finds in the bag.
      </li>
      <li>
      ...
      <li><h4>Selling Items</h4>
        Selling your items. One word of advice, don’t be in a hurry.  Look at all your options and make an educated choice.  Jewelry stores, Pawn shops, We by gold places,  ALL will tell you they pay the highest price.  Find out what its worth before you talk to them.  You can visit<a href="http://www.dendritics.com/scales/metal-calc.asp"> this site</a>  to calculate the value of precious metals. You will need a scale which you can buy cheap on auction sites.
      </li>
      <li>
  ...
  <!-- end tips begin resource sidebar -->
  <div class="columns small-12 medium-3">
    <ul class="border-solid-left no-bullet">
      <h4>Resources</h4>
      <h5>Forums</h5>
      <li><a href="http://metaldetectingforum.com/index.php">Friendly Metal Detecting</a></li>
      <li><a href="http://www.findmall.com/">Finds Treasure Forum</a></li>
      <h5>Treasure Hunting Supplies</h5>
      <li><a href="http://www.bigboyshobbies.net/"></a></li>
      <li><a href="http://www.myersdepot.com/">Meyers Metal Detectors</a></li>
      <li><a href="http://stealthscoop.com/">Stealth Scoops</a></li>
      <h5>Precious Metal Prices &amp; Buyers</h5>
      <li><a href="http://dendritics.com/metal-calc/">Precious Metal Calculator</a></li>
      <li><a href="http://coinapps.com/silver/coin/calculator/">Silver Coin Melt Value</a></li>
      <li><a href="http://coinapps.com/silver/coin/canadian/calculator/">Canadian Silver Coin Melt Value</a></li>
      <li><a href="http://aragold.com/">ARA Gold</a></li>
    </ul>
  </div>
